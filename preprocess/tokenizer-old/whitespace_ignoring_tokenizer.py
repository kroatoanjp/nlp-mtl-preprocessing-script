...
# Adds basic symbol replacement methods for tokenizers that
# do not respect whitespace
class WhitespaceIgnoringTokenizer(Tokenizer):
    ...
    def _preprocess_text(self, text: str) -> str:
        ...
        # after tagging.
        text = re.sub(r'\s',  WhitespaceIgnoringTokenizer.PUNCTUATION_REPLACEMENT_TOKEN, text)
        ...
        text = text.replace('・', WhitespaceIgnoringTokenizer.PUNCTUATION_REPLACEMENT_TOKEN)
        return text
